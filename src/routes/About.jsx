/*
    here i am using shadcn components like Tabs, Tooltip, TooltipContent, TooltipProvider, TooltipTrigger to create a tabbed layout for about page and make the ui look good, I have made customisations in the components myself
*/
