/*
 * Renders the Leetcode component.
 *
 * This component fetches Leetcode statistics from an API and displays them in a visually appealing way.
 * It shows the number of easy, medium, and hard questions solved, as well as the total number of questions solved.
 * The component also calculates the progress percentage for each difficulty level.
 *
 * @returns {JSX.Element} The rendered Leetcode component.
*/
